...
import view.AddProjectController;
...
public class Proyectos {
    ...
    public static void registrarProyecto(String direccion,String nombre, String categoria, String fechaCreacion,  String ultimaModificacion, String repositorio){
            Proyecto nuevoProyecto = (new Proyecto(direccion,nombre,categoria,fechaCreacion, ultimaModificacion, repositorio));
